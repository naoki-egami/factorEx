# (OLD; Internal Functions) Help functions  (not updated after 09/19/2019; see AME_fit_basic.R)
...
# Functions don't model two-way interactions
...
#' #' @export
#'
#' decompose_pAMCE <- function(outAME, factor_name, level_name, target_diff = c("Pop", "Exp")){
#'
#'   marginal_dist <- outAME$input$marginal_dist
#'   marginal_dist_u_list  <- outAME$input$marginal_dist_u_list
#'   marginal_dist_u_base  <- outAME$input$marginal_dist_u_base
